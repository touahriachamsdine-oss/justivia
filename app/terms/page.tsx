...
import { FileText, Scale, ShieldAlert, AlertTriangle } from 'lucide-react';
      ...
      <div className="w-full max-w-4xl mx-auto z-10">
        ...
        >
          ...
          >
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-soft rounded-2xl flex items-center justify-center shrink-0 shadow-premium">
                <AlertTriangle className="w-6 h-6 text-legal-red" />
              </div>
              <div>
                <h2 className="font-cairo text-xl font-black text-primary mb-3">
          ...
          >
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-soft rounded-2xl flex items-center justify-center shrink-0 shadow-premium">
                <ShieldAlert className="w-6 h-6 text-legal-red" />
              </div>
              <div>
                <h2 className="font-cairo text-xl font-black text-primary mb-3">
